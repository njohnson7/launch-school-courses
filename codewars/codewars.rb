...
list2 = [
  { first_name: 'Oliver', last_name: 'Q.', country: 'Australia', continent: 'Oceania', age: 19, language: 'HTML' },  # => {:first_name=>"Oliver", :last_name=>"Q.", :country=>"Australia", :continent=>"Oceania", :age=>19, :language=>"HTML"}
  { first_name: 'Lukas', last_name: 'R.', country: 'Austria', continent: 'Europe', age: 89, language: 'HTML' }       # => {:first_name=>"Lukas", :last_name=>"R.", :country=>"Austria", :continent=>"Europe", :age=>89, :language=>"HTML"}
]                                                                                                                    # => [{:first_name=>"Oliver", :last_name=>"Q.", :country=>"Australia", :continent=>"Oceania", :age=>19, :language=>"HTML"}, {:first_name=>"Lukas", :last_name=>"R.", :country=>"Austria", :continent=>"Europe", :age=>89, :language=>"HTML"}]

list1 = [
  { first_name: 'Noah', last_name: 'M.', country: 'Switzerland', continent: 'Europe', age: 19, language: 'JavaScript' },  # => {:first_name=>"Noah", :last_name=>"M.", :country=>"Switzerland", :continent=>"Europe", :age=>19, :language=>"JavaScript"}
  { first_name: 'Maia', last_name: 'S.', country: 'Tahiti', continent: 'Oceania', age: 28, language: 'JavaScript' },      # => {:first_name=>"Maia", :last_name=>"S.", :country=>"Tahiti", :continent=>"Oceania", :age=>28, :language=>"JavaScript"}
  { first_name: 'Shufen', last_name: 'L.', country: 'Taiwan', continent: 'Asia', age: 35, language: 'HTML' },             # => {:first_name=>"Shufen", :last_name=>"L.", :country=>"Taiwan", :continent=>"Asia", :age=>35, :language=>"HTML"}
  { first_name: 'Sumayah', last_name: 'M.', country: 'Tajikistan', continent: 'Asia', age: 30, language: 'CSS' }          # => {:first_name=>"Sumayah", :last_name=>"M.", :country=>"Tajikistan", :continent=>"Asia", :age=>30, :language=>"CSS"}
]                                                                                                                         # => [{:first_name=>"Noah", :last_name=>"M.", :country=>"Switzerland", :continent=>"Europe", :age=>19, :language=>"JavaScript"}, {:first_name=>"Maia", :last_name=>"S.", :country=>"Tahiti", :continent=>"Oceania", :age=>28, :language=>"JavaScript"}, {:first_name=>"Shufen", :last_name=>"L.", :country=>"Taiwan", :continent=>"Asia", :age=>35, :language=>"HTML"}, {:first_name=>"...
