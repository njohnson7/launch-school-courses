...
- referencing `event` in the `divBlue` callback function works on Chrome, since it sets `event` as a global variable, but throws an error on Firefox

___

- "that occur on web page"
- `div[Color]` variables are not defined
- "`<div id="orange">Yellow`"
- "order: div#blue, div#red, div#yellow, and div#green."
- "`= [div#blue, div#red, div#yellow, div#green]`"
- "it has private events variable"
- isn't there a third purpose of adding the `event` parameter to the tracker?: "parameter: event. This parameter has two purposes:"
