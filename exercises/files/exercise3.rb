# exercise3.rb
# Take articles from a json and an xml file, extract the title, link, and summary fields from them, combine them into one array,
#  sorted alphabetically by title, and store the result in a CSV and an XLS file

# I did this in irb but I copied the code to here for reference
