...
class LinkedListTest < Minitest::Test
  ...
  def test_2_elements_tails
    e1 = Element.new(1)
    e2 = Element.new(2, e1)
    assert_equal true, e1.tail?
    assert_equal false, e2.tail?
  end
  ...
  def test_items_are_stacked
    ...
    assert_equal 2, l.head.datum           # head == 2
    assert_equal 1, l.head.next.datum      # head.next == 1
  end
